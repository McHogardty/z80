const unsigned char font[96][6] = {
	...
	{0x18,0x14,0x12,0x11,0x7f,0x00}, // 4
	...
	{0x3e,0x41,0x5d,0x5d,0x51,0x5e}, // @
	{0x7e,0x05,0x05,0x05,0x7e,0x00}, // A
	{0x7f,0x45,0x45,0x45,0x3a,0x00}, // B
	{0x3e,0x41,0x41,0x41,0x22,0x00}, // C
	{0x7f,0x41,0x41,0x41,0x3e,0x00}, // D
	{0x7f,0x45,0x45,0x41,0x41,0x00}, // E
	{0x7f,0x05,0x05,0x01,0x01,0x00}, // F
	{0x3e,0x41,0x45,0x45,0x3d,0x00}, // G
	{0x7f,0x04,0x04,0x04,0x7f,0x00}, // H
	{0x41,0x7f,0x41,0x00,0x00,0x00}, // I
	{0x20,0x40,0x40,0x40,0x3f,0x00}, // J
	{0x7f,0x04,0x04,0x0a,0x71,0x00}, // K
	{0x7f,0x40,0x40,0x40,0x40,0x00}, // L
	{0x7f,0x02,0x04,0x02,0x7f,0x00}, // M
	{0x7f,0x02,0x04,0x08,0x7f,0x00}, // N
	{0x3e,0x41,0x41,0x41,0x3e,0x00}, // O
	{0x7f,0x05,0x05,0x05,0x02,0x00}, // P
	{0x3e,0x41,0x41,0x21,0x5e,0x00}, // Q
	{0x7f,0x05,0x05,0x05,0x7a,0x00}, // R
	{0x22,0x45,0x45,0x45,0x39,0x00}, // S
	...
	{0x04,0x7e,0x05,0x05,0x00,0x00}, // f
	{0x98,0xa4,0xa4,0xa4,0x7c,0x00}, // g
	{0x7f,0x08,0x04,0x04,0x78,0x00}, // h
	{0x7d,0x00,0x00,0x00,0x00,0x00}, // i
	{0x60,0x80,0x80,0x80,0x7d,0x00}, // j
	{0x7f,0x10,0x28,0x44,0x00,0x00}, // k
	{0x3f,0x40,0x00,0x00,0x00,0x00}, // l
	{0x7c,0x04,0x18,0x04,0x78,0x00}, // m
	{0x7c,0x04,0x04,0x04,0x78,0x00}, // n
	{0x38,0x44,0x44,0x44,0x38,0x00}, // o
	{0xfc,0x28,0x24,0x24,0x18,0x00}, // p
	{0x18,0x24,0x24,0x28,0xfc,0x00}, // q
	{0x7c,0x08,0x04,0x04,0x08,0x00}, // r
	{0x48,0x54,0x54,0x54,0x24,0x00}, // s
	{0x02,0x3f,0x42,0x00,0x00,0x00}, // t
	{0x3c,0x40,0x40,0x40,0x7c,0x00}, // u
	{0x1c,0x20,0x40,0x20,0x1c,0x00}, // v
	{0x3c,0x40,0x70,0x40,0x7c,0x00}, // w
	{0x44,0x28,0x10,0x28,0x44,0x00}, // x
	{0x9c,0xa0,0xa0,0xa0,0x7c,0x00}, // y
...
#define FONT_NAME "Minecraftia-Regular_font"
